...
<body>
	<form method="post" action="276_registerPro.jsp">
		<table>
			<tr>
				<td class="label"><label for="id">아이디</label>
				<td class="content"><input id="id" name="id" type="text" size="20" required>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="content"><input id="name" name="name" type="text" size="20" required>
			</tr>
			<tr>
